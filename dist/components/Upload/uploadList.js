    ...
    return (React.createElement("ul", { className: "upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "upload-list-item", key: item.uid },
            ...
            React.createElement("span", { className: "file-status" },
                ...
                item.status === 'success' && React.createElement(Icon, { icon: "check-circle", spin: true, theme: "success" }),
                item.status === 'error' && React.createElement(Icon, { icon: "times-circle", spin: true, theme: "danger" })),
