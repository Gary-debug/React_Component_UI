...
export var Input = forwardRef(function (props, ref) {
    var _a;
    var disabled = props.disabled, size = props.size, icon = props.icon, prepend = props.prepend, append = props.append, style = props.style, children = props.children, restProps = __rest(props, ["disabled", "size", "icon", "prepend", "append", "style", "children"]);
